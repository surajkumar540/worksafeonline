...
const Marquee: React.FC = () => {
  return (
    <div className="overflow-hidden mb-10 whitespace-nowrap relative bottom-7 w-full bg-primary">
      <div className="marquee h-20 flex justify-center items-center">
        <span
          className={`text-3xl uppercase tracking-wider flex justify-center items-center ${bigShoulders.className}`}
        >
