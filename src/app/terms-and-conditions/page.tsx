    ...
    <div className="bg-white max-w-9xl font-sans mx-auto px-4 md:px-6 lg:px-10 pb-6">
      ...
      <section className="mb-6 mt-4">
        ...
        <p className="mb-4">
          ...
          how you or we may change or end the contract, what to do if there is a
          problem, and other important information. If you think there is a
          mistake in these terms, please contact us to discuss this, by any of
          the methods listed in clause 2.1.
        </p>
        <p className="mb-4">
          <strong>1.3 </strong>
          In some areas, you will have different rights under these terms
          depending on whether you are a business or consumer customer. You are
          a consumer customer if:
        </p>
        ...
        <p className="mb-4">
          <strong>1.4 </strong> If you are a business customer, these terms and
          conditions apply to the contract between you and us, to the exclusion
          of any other terms that you seek to impose or incorporate, or which
          are implied by trade, custom, practice or course of dealing. These
          terms also constitute the entire agreement between us in relation to
          your purchase. You acknowledge that you have not relied on any
          ...
          misrepresentation based on any statement in this agreement. Your
          attention is also particularly drawn to the provisions of clause 20 of
          these terms.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          ...
          NN18 8AL. You can contact us by telephone on 01536 203 888, in writing
          at Worksafe Direct (UK) Limited, St James Road, St James Industrial
          Estate, Corby, Northamptonshire, NN18 8AL, or by email to{" "}
          <a
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          <strong>3.2 </strong> We will assign an order number to your order and
          tell you what it is when we accept your order. It will help us if you
        ...
        <p className="mb-4">
          ...
          delivered to an address in Northern Ireland, then please note that the
          delivery provisions stated in these terms may vary. Please contact us
          prior to placing your order and we can advise you further.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          ...
          contact us as soon as possible. We will let you know if the change is
          possible. If the change is possible, we will let you know about any
          changes to the price of the product, whether the change will cause any
          delays in supplying the product, or anything else which would be
          necessary as a result of your request. We will then ask you to confirm
          to us whether you wish to go ahead with your request to change your
          order.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          On some occasions, we may have to change the product, for example, to
          reflect changes to relevant laws or regulatory requirements, or to
          implement minor technical adjustments and improvements. If we have to
          change your order in any way, we will notify you.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          ...
          which are Monday to Friday 8:00 am to 5:00 pm and Saturday 8:00 am to
          12:00 pm, and you must do so within 10 days of us notifying you that
        ...
        <div className="mb-4">
          ...
          <ol className="list-disc pl-6 mb-4">
            <li>
              ...
              estimated delivery date, which is normally within 30 days from the
              day after we accept your order. If the goods are not available to
              be delivered to you within this period, we will contact you to
              notify you. Depending on the nature and size of the goods, we will
              either deliver the goods ourselves or via a third-party courier;
            </li>
            <li>
              (b) if the products are services, the estimated completion date
              for the services will be notified to you during the order process;
              and
            </li>
            <li>
        ...
        <p className="mb-4">
          <strong>7.3 </strong>
          If you are not at home when the product is delivered and the products
          cannot be posted through your letterbox, we will try to rearrange
          delivery, or if possible, you may collect them from our store.
        </p>
        <p className="mb-4">
          <strong>7.4 </strong>
        ...
        <p className="mb-4">
          ...
          good reason for this), we may charge you additional costs incurred by
          us as a result. If, despite our reasonable efforts, we are unable to
          contact you or rearrange access to your property, we may end the
          contract and clause 13.2 will apply.
        </p>
        <p className="mb-4">
          <strong>7.6 </strong>
          If our supply of the products is delayed by an event outside our
          control, then we will contact you as soon as possible to let you know,
          and we will take steps to minimize the effect of the delay. Provided
          we do this, we will not be liable for delays caused by the event. But
          if there is a risk of substantial delay, you may contact us to end the
          contract and receive a refund for any products you have paid for but
          not received.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-4">
          ...
          <ol className="list-disc pl-6">
            ...
            <li>
              (c) on delivery of the products by us to the address specified by
              you, if the products are being delivered by us.
            </li>
          </ol>
          <p>
            <strong>8.2</strong> If we miss the delivery deadline for any
            products then you may treat the contract as at an end straight away
          ...
          <ol className="list-disc pl-6">
            ...
            <li>
              (c) you told us before we accepted your order that delivery within
              the delivery deadline was essential.
            </li>
          </ol>
          <p>
            <strong>8.3</strong> If you do not wish to treat the contract as at
            an end straight away, or do not have the right to do so under clause
            8.2 you can give us a new deadline for delivery, which must be
            reasonable, and you can treat the contract as at an end if we do not
            meet the new deadline.
          </p>
          <p>
            <strong>8.4</strong> IIf you do choose to treat the contract as at
            ...
            have been delivered. If you wish, you can reject or cancel the order
            for some of those products (not all of them), unless splitting them
            up would significantly reduce their value. After that we will refund
            any sums you have paid to us for the cancelled products and their
            delivery. If the products have been delivered to you, you will have
            to return them to us or allow us to collect them, and we will pay
            the costs of this.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ol className="list-disc pl-6">
            <li>
              (a) on delivery of the products at our premises, if you have
              arranged to collect the products
            </li>
            <li>
              (b) on delivery of the products by us to the applicable
              third-party courier, if the products are being delivered by a
          ...
          <p>
            ...
            are approximate only and the time of delivery is not of the essence.
            ...
            available. We shall not be liable for any delay in delivery that is
            due to a reason beyond our reasonable control or if you fail to
            provide us with adequate delivery instructions that are relevant to
        ...
        <div className="space-y-4">
          <p>
            ...
            have received payment for the goods in full. (subject to clause 10.3
            if you are a business customer and clause 10.2 and 10.3 applies).
          </p>
          <p>
            <strong>10.2 </strong>If you are a business customer, we are able to
            offer some of our customers goods on consignment (whereby we
            purchase a set amount of goods from our suppliers, at your request,
            store the goods in our warehouse, allow you to take possession of
            the goods for your use or resale, subject to our consignment terms
            and conditions, but retain ownership of such goods until they are
            paid for by the applicable customer (Consignment Goods). In this
            instance, we will require you to enter into our consignment terms
            and conditions, which will apply in addition to these terms and
            conditions.
          </p>
          <p>
            ...
            will apply in addition to these terms and conditions, in relation to
            any such Consignment Goods:
          </p>
          <p>
          ...
          <ol className="list-disc pl-6">
            <li>
              (i) we receive payment in full (in cash or cleared funds) for the
              Consignment Goods and any other goods that we have supplied to
              you, in which case title to the Consignment Goods shall pass at
              the time of payment of all such sums; or
            </li>
            <li>
              (ii) you resell the Consignment Goods, in which case ownership
              will pass at the time of resale.you resell the Consignment Goods,
              in which case ownership of the Consignment Goods shall pass to the
              you at the time specified in clause 10.3 (b).
            </li>
          </ol>

          <p>
            (b)Subject to clause 10.3(d), you may resell or use the Consignment
            Goods in the ordinary course of your business (but not otherwise)
            before we receive payment for the Consignment Goods. However, if you
            resell the Consignment Goods before that time:
          </p>
          <ol className="list-disc pl-6">
          ...
          <p>
            (c) Until ownership of the Consignment Goods has passed to you, you
            shall:
          </p>
          <ol className="list-disc pl-6">
            <li>
            ...
            <li>
              (iii) maintain the Consignment Goods in satisfactory condition and
            ...
            <li>
              ...
              Consignment Goods which have been damaged by you or a third party
              whom you have permitted to have control of the Consignment Goods;
            </li>
            <li>
            ...
            <li>
              (vi) give us such information relating to the Consignment Goods as
              we may require from time to time.
            </li>
          </ol>

          <p>
            (d) If before ownership of the Consignment Goods passes to you, you
            become subject to any of the events listed in clause 13.1(e) then,
            without limiting any other right or remedy, we may at any time:
          </p>
          <ol className="list-disc pl-6">
            <li>
              (i) require you to deliver up all of the Consignment Goods in your
              possession that have not been resold, or irrevocably incorporated
          ...
          <p>
            (e) If the Consignment Goods consist of goods which are non-standard
            goods, and you do not purchase such goods from us, in accordance
            with our consignment terms and conditions, we will charge you a
            restocking fee of 25 % of the sale price of the applicable product.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <p>
            <strong>11.1</strong>
            {` The price of the product will be the price
              indicated on the order pages when you place your order. We take
              all reasonable care to ensure that the price of the product
              advised to you is correct. However, it is always possible that,
              despite our best efforts, some of the products we sell may be
              incorrectly priced. We will normally check prices before accepting
              your order so that, where the product's correct price at your
              order date is less than our stated price at your order date, we
              will charge the lower amount. If the product's correct price at
              your order date is higher than the price stated to you, we will
          ...
          <p>
            <strong>11.3</strong> Whether the price stated includes value-added
            tax (VAT) or not will be stated on each product and our
            acknowledgment of your order.
          </p>
          <p>
            <strong>11.4</strong> If the rate of VAT changes between your order
            date and the date we supply the product, we will adjust the rate of
            VAT accordingly.
          </p>

          <p>
            <strong>11.5</strong> If the rate of VAT changes between your order
            date and the date we supply the product, we will adjust the rate of
            VAT that you pay, unless you have already paid for the product in
            full before the change in the rate of VAT takes effect.
          </p>

          <p>
            <strong>11.6</strong> When you must pay for the products depends on
            whether you are a consumer customer or business customer and what
            type of account you have with us.
          </p>
          ...
          <p>
            ...
            account with us, please contact us. We will notify you in writing to
            confirm whether we are able to offer you a trade account and any
            applicable payment terms. If you have a trade account with us, then
            payment for the products will be due within 30 days from the end of
            the month in which the products were ordered, unless otherwise
            agreed by us in writing.
          </p>

          <p>
            <strong>11.8 </strong> If you are a business or consumer customer
            and you do not have a trade account with us, then the price for the
            products will be payable on collection or delivery of the goods (as
            the case may be). However, if you order any customised/bespoke
            products, or any non-standard items (these are goods which we would
            not normally stock but have stocked these upon your request) then
            these products must be paid for by you at the time you place your
            order.
          </p>
          <p>
          ...
          <ol className="list-disc pl-6">
            <li>
              (a) If you are a consumer customer and you do not make any payment
              to us by the due date, we may charge interest to you on the
              overdue amount at the rate of 4% a year above the base lending
              rate of Barclays Bank from time to time. This interest shall
            ...
            <li>
              (b)If you are a business customer and you do not make any payment
              to us by the due date we may charge interest to you on the overdue
              amount at the rate of 8% a year above the base lending rate of
              Barclays Bank from time to time. This interest shall accrue on a
              ...
              us interest together with any overdue amount. You will indemnify
              us against all liabilities, costs, expenses, damages and losses,
              including all interest, penalties, and legal costs (calculated on
              a full indemnity basis), suffered or incurred by us arising out of
              or in connection with the enforcement of the contract.
            </li>
          </ol>
      ...
      <section className="mb-8">
        ...
        <p className="text-lg mb-4">
          ...
          requirements. If so, this will have been stated in the description of
          the products on our website. If you do not give us this information
          within a reasonable time of us asking for it, or if you give us
          incomplete or incorrect information, we may either end the contract
          (and clause 13.2 will apply) or make an additional charge of a
          reasonable sum to compensate us for any extra work that is required as
          a result. We will not be responsible for supplying the products late,
          or not supplying any part of them, if this is caused by you not giving
          us the information we need within a reasonable time of us asking for
          it.
        </p>
        <div className="text-lg mb-4">
          ...
          <ol className="list-disc pl-8">
            ...
            <li>
              make changes to the product as requested by you or notified by us
              to you.
            </li>
          </ol>
        </div>
        ...
        <p className="text-lg mb-4">
          ...
          until you have paid us the outstanding amounts. We will contact you to
          tell you we are suspending supply of the products. We will not suspend
          the products where you dispute the unpaid invoice (see clause 11.12)
          providing that you notify us as soon as possible as soon as you become
          aware of the same. We will not charge you for the products during the
          period for which they are suspended. As well as suspending the
          products we can also charge you interest on your overdue payments (see
          clause 11.11).
        </p>
      </section>
        ...
        <div className="text-lg mb-4">
          ...
          <ol className="list-disc pl-8">
            <li>
              ...
              received payment within 7 days of us reminding you that payment is
              due;
            </li>
            <li>
              ...
              products, for example a delivery address;
            </li>
            <li>
            ...
            <li>
              ...
              <ol className="list-inside pl-8">
                <li>
                  ...
                  any of your assets or ceasing to carry on business; or
                </li>

                <li>
                  (ii) you suspend, or threaten to suspend, or cease or threaten
                  to cease, to carry on all or a substantial part of your
                  business; or
                </li>

                <li>
                  (iii) your financial position deteriorates to such an extent
                  that in our opinion your capability to adequately fulfil its
                  obligations under the contract between you and us has been
                  placed in jeopardy; or
                </li>

                <li>
                  (iv) we reasonably believe that you are about to take any of
                  the actions, or become subject to any of the events listed in
                  clause 13.1 (e) (i) to 13.1 (e) (iii).
                </li>
              </ol>
            </li>
          </ol>
          <p>
            {" "}
            (f) If you are a consumer customer and you stop or suspend payment
            of any of your debts, or are unable to, or you admit your inability
      ...
      <section className="mb-8">
        ...
        <p className="text-lg mb-4">
          ...
          contract will depend on what you have bought, whether there is
          anything wrong with it, how we are performing, when you decide to end
          the contract and whether you are a consumer customer or business
          customer:
        </p>
        <ol className="list-disc pl-8 mb-4">
          ...
          <li>
            ...
            have told you we are going to do, see clause 14.2;
          </li>

          <li>
            If you are a consumer and have just changed your mind about the
            product, see clause 14.3. You may be able to get a refund if you are
            within the cooling-off period, but this may be subject to deductions
            and you will have to pay the costs of return of any goods; or
          </li>

          <li>
            In all other cases (if we are not at fault and you are not a
        ...
        <p className="text-lg mb-4">
          ...
          the contract will end immediately and we will refund you in full for
          any products which have not been provided and you may also be entitled
          to compensation. The reasons are:{" "}
        </p>
        <ol className="list-disc pl-8 mb-4">
          <li>
            we have told you about an upcoming change to the product or these
            terms which you do not agree to (see clause 6);
          </li>
          <li>
          ...
          <li>
            there is a risk that supply of the products may be significantly
          ...
          <li>
            ...
            each case for a period of more than 10 days; or
          </li>

          <li>
            you have a legal right to end the contract because of something we
            have done wrong.
          </li>
        </ol>
        ...
        <ol className="list-disc pl-8 mb-4">
          <li>
            then for most products bought online you have a legal right to
            change your mind within 14 days and receive a refund. These rights,
            under the Consumer Contracts Regulations 2013, are explained in more
            detail in these terms. If you wish to exercise your right to cancel
            the contract, please notify us in writing. You may wish to use the
            model cancellation form, which is attached to these terms and
            conditions.
          </li>
          <li>
            Your right as a consumer to change your mind under the Consumer
            Contract Regulations 2013 does not apply in respect of:
            <p>
            ...
            <p>
              (iii) any goods which have been customised to your requirements or
              bespoke goods;
            </p>
            <p>
            ...
            <p>
              (v) products which become mixed inseparably with other items after
              their delivery.
            </p>
          </li>

          <li>
            how long you have to change your mind under the Consumer Contract
            Regulations 2013 depends on what you have ordered and how it is
            delivered:
            <p>
        ...
        <p className="text-lg mb-4">
          <strong>14.3 </strong>
          Ending the contract where we are not at fault and there is no right to
          change your mind. Even if we are not at fault and you are not a
          consumer who has a right to change their mind (see clause 14.1), you
          can still end the contract before it is completed, but you may have to
          pay us compensation. A contract for goods is completed when the
          ...
          you want to end a contract before it is completed where we are not at
          fault and you are not a consumer who has changed their mind, just
          contact us to let us know. The contract will end immediately and we
          will refund any sums paid by you for products not provided but we may
          deduct from that refund (or, if you have not made an advance payment,
          charge you) reasonable compensation for the net costs we will incur as
          a result of you ending the contract. Unfortunately, if you have
          ordered customised/ bespoke goods, such as goods containing your logo
          or business name, you are not entitled to return these items unless
          they are defective. In addition, if you have ordered undergarments or
          thermal underwear you are not able to return these goods unless they
          are defective and unworn. Any footwear must be returned to us in the
          original condition and unworn, unless they are defective.
        </p>
      </section>
      ...
      <section className="my-8">
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            products have been dispatched to you or you have received them, you
            must return them to us. You must either return the goods in person
            to where you bought them, post them back to us or (if they are not
            suitable for posting) allow us to collect them from you. If you are
            a consumer exercising your right to change your mind you must send
            off the goods within 14 days of telling us you wish to end the
            contract.
          </p>
          <p>
          ...
          <ol className="list-disc pl-6">
            ...
            <li>
              if you are ending the contract because we have told you of an
              upcoming change to the product or these terms, an error in pricing
              or description, a delay in delivery due to events outside our
              control or because you have a legal right to do so as a result of
              something we have done wrong.
            </li>
          </ol>
          <p>In all other cases, you must pay the costs of return.</p>
          <p>
            <strong>15.4</strong> If you are responsible for the costs of return
            and we are collecting the product from you, we will charge you the
            direct cost to us of collection.
          </p>
          <p>
          ...
          <ol className="list-disc pl-6">
            <li>
              we may reduce your refund of the price (excluding delivery costs)
              to reflect any reduction in the value of the goods, if this has
              been caused by your handling them in a way which would not be
              permitted in a shop. If we refund you the price paid before we are
              able to inspect the goods and later discover you have handled them
            ...
            <li>
              ...
              example, if we offer delivery of a product within 3-5 days at one
              cost but you choose to have the product delivered within 24 hours
              at a higher cost, then we will only refund what you would have
              paid for the cheaper delivery option.
            </li>
            <li>
              where the product is a service, we may deduct from any refund an
              amount for the supply of the service for the period for which it
              was supplied, ending with the time when you told us you had
              changed your mind. The amount will be in proportion to what has
              been supplied, in comparison with the full coverage of the
              contract.
            </li>
          </ol>
          ...
          <ol className="list-disc pl-6">
            <li>
              if the products are goods and we have not offered to collect them,
              your refund will be made within 14 days from the day on which we
              receive the product back from you or, if earlier, the day on which
              you provide us with evidence that you have sent the product back
              to us;
            </li>
            <li>
        ...
        <section id="consumer-rights" className="my-8">
          ...
          <p>
            <strong>17.1</strong> If you are a consumer customer we are under a
            ...
            in relation to the products. Nothing in these terms will affect your
            legal rights.Summary of your key legal rightsThis is a summary of
            your key legal rights. These are subject to certain exceptions. For
            detailed information please visit the Citizens Advice website
            www.adviceguide.org.uk or call 03454 04 05 06.
          </p>
          <ol className="list-disc pl-6">
            <li>
              If your product is goodsThe Consumer Rights Act 2015 says goods
              must be as described, fit for purpose and of satisfactory quality.
              During the expected lifespan of your product your legal rights
          ...
          <p>
            Please note that all of our goods are off the shelf products and we
            make no representation or give any warranty that the goods are fit
            for a particular purpose. You should satisfy yourself that any goods
            you purchase from us are for the purpose you require.
          </p>

          <p>
            <strong>17.2</strong> If you wish to exercise your legal rights to
            reject products, you must either return them in person to where you
            bought them, post them back to us or (if they are not suitable for
            posting) allow us to collect them from you. We will pay the costs of
        ...
        <section id="business-rights" className="my-8">
          ...
          <p>
            <strong>18.1</strong> If you are a business customer we warrant that
            on delivery of the goods and for such period as is stated on the
            applicable goods (Warranty Period) that the applicable goods shall:
          </p>
          ...
          <ol className="list-disc pl-6">
            ...
            <li>
              ...
              <p>{` be fit for any purpose held out by us.`}</p>
            </li>
          ...
          <p>
            <strong>18.2</strong> Subject to clause 18.3, if:
          </p>
        ...
        <section id="consumer-liability" className="my-8">
          <h2
            className={`text-3xl font-bold text-gray-800 my-5 ${bigShoulders.className}`}
          >
            19. OUR RESPONSIBILITY FOR LOSS OR DAMAGE SUFFERED BY YOU IF YOU ARE
            A CONSUMER CUSTOMER
          </h2>
          <p>
            <strong>19.1</strong> We are responsible to you for foreseeable loss
            and damage caused by us. If we fail to comply with these terms, we
            are responsible for loss or damage you suffer that is a foreseeable
            result of us breaking this contract or as a result of us failing to
          ...
          <p>
            ...
            the negligence of our employees, agents or subcontractors; for fraud
            or fraudulent misrepresentation; for breach of your legal rights in
            relation to the products as summarised at clause 17.1 and for
          ...
          <p>
            ...
            the products for to you for domestic and private use. If you use the
            products for any commercial, business or re-sale purpose our
      ...
      <div className="mb-6">
        <h3
          className={`text-3xl font-bold text-gray-800 my-5 ${bigShoulders.className}`}
        >
          20. OUR RESPONSIBILITY FOR LOSS OR DAMAGE SUFFERED BY YOU IF YOU ARE A
          BUSINESS CUSTOMER
        </h3>
        <p className="mb-3">
          <strong>20.1 </strong>
        ...
        <p className="mb-3">
          <strong>20.2 </strong>
          Except to the extent expressly stated in clause 18.1 all terms implied
          by sections 13 to 15 of the Sale of Goods Act 1979 and sections 3 to 5
        ...
        <ol className="list-disc pl-6 space-y-2">
          <li>
            ...
            any loss of profit, or any indirect or consequential loss arising
            under or in connection with any contract between us;
          </li>
          <li>
            (b) our total liability to you for all other losses arising under or
            in connection with any contract between us, whether in contract,
            tort (including negligence), breach of statutory duty, or otherwise,
            shall be limited to the total sums paid by you for products under
            such contract.
          </li>
        </ol>
        <p className="mb-3">
          ...
          range, such goods are not permitted to be resold or made available to
          consumers and are not permitted to be sold or used by the general
          public. By purchasing any goods from our janitorial range from us, you
          acknowledge and agree that you will not resell or make available any
          such goods to any consumers or the general public.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <ol className="list-disc pl-6 space-y-2">
          ...
          <li>
            ...
            information about similar products that we provide, but you may stop
      ...
      <div className="mb-6">
        ...
        <ol className="list-disc pl-6 space-y-2">
          <li>
            (a) We may transfer our rights and obligations under these terms to
          ...
          <li>
            ...
            services, any item or property in respect of which we have provided
            the services.
          </li>
          <li>
            (c) This contract is between you and us. No other person shall have
          ...
          <li>
            (f) These terms are governed by English law and you can bring legal
          ...
          <li>
            (g) If you are a business, any dispute or claim arising out of or in
