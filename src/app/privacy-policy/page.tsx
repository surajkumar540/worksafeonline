...
export default function Page() {
  return (
    <div className="pt-[10vh] md:pt-[15vh]">
      {`IntroductionWelcome to Worksafe Direct (UK) Limited (company number: 07995116) trading as Worksafe and WorksafeOnline and whose registered office is at St James Road, St James Industrial Estate, Corby, Northamptonshire, NN18 8A (the Company)’s privacy policy.
...
Contact detailsIf you have any questions about this privacy policy or our privacy practices, please contact our Compliance Manager in the following ways:

Name of Compliance Manger: Matthew StevensFull name of legal entity: Worksafe Direct (UK) Limited (company number: 07995116)Email address: Matt@worksafeonline.co.ukPostal address: St James Road, St James Industrial Estate, Corby, Northamptonshire, NN18 8AL.Telephone number: 01536 203888.

You have the right to make a complaint at any time to the Information Commissioner's Office (ICO), the UK supervisory authority for data protection issues (www.ico.org.uk). We would, however, appreciate the chance to deal with your concerns before you approach the ICO so please contact us in the first instance.

Changes to the privacy policy and your duty to inform us of changesWe keep our privacy policy under regular review. It is important that the personal data we hold about you is accurate and current. Please keep us informed if your personal data changes during your relationship with us.
...
1. The data we collect about youPersonal data, or personal information, means any information about an individual from which that person can be identified. It does not include data where the identity has been removed (anonymous data).
...
2. How is your personal data collected?We use different methods to collect data from and about you including through:
...
3. How we use your personal dataWe will only use your personal data when the law allows us to. Most commonly, we will use your personal data in the following circumstances:
...
(c) where necessary, notifying our suppliers, such as Polyco Healthline to enable them to deliver our products direct to you.	(a) Identity
(b) Contact
(c) Financial
(d) Transaction
...
Opting outYou can ask us or third parties to stop sending you marketing messages at any time by contacting us at any time.

Where you opt out of receiving these marketing messages, this will not apply to personal data provided to us as a result of a product/service purchase, warranty registration, product/service experience or other transactions.

CookiesYou can set your browser to refuse all or some browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies, please note that some parts of this website may become inaccessible or not function properly.
...
4. Disclosures of your personal dataWe may share your personal data with the parties set out below for the purposes set out in the table above.

Internal Third PartiesOther companies or entities, which the shareholders of the Company have an interest A14 Supplies Ltd and Maskearid Ltd.

External Third Parties• Suppliers, such as Polyco Healthline;
...
8. Your legal rightsUnder certain circumstances, you have rights under data protection laws in relation to your personal data.
