  ...
  return (
    <div className="w-full mt-4 lg:mt-0">
      <div>
        ...
        <h1
          className={`text-5xl py-5 font-black uppercase ${bigShoulders.className}`}
        >
      ...
      <p className="mt-4 text-gray-500 text-lg font-thin">
      ...
      <div className=" mt-4   flex  flex-col items-center justify-center border rounded-md gap-4">
        <p className="mt-4">Guarantee Safe & Secure Checkout</p>
      ...
      <div className=" mt-4 flex flex-col  uppercase gap-2 text-sm">
        <div className="flex items-center   gap-3">
          <span className="text-gray-400">
            SKU: <span className="text-black">h67910625</span>
          </span>
        </div>

        <div className="flex items-center   gap-3">
          <span className="text-gray-400">
            Category: <span className="text-black">Jackets</span>
          </span>
        </div>
      </div>
    </div>
